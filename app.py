...
@app.route('/predictEmo' , methods = ['POST'])
def review():
    ...
    # example : Positive , ./static/assets/emoticons/positive.png
        ...
        predicted_emotion , prdicted_emotion_img_url= sa.predict(review)

        return jsonify({'sentiment':predicted_emotion , 'emo_url':prdicted_emotion_img_url})
